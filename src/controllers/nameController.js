...
const submitName = (req, res) => {
    ...
    nameController.addName(name);        // Thêm tên vào danh sách trong model names
    res.json({ message: `Xin chào, ${name}!`, names: nameController.getNames() }); // Trả về JSON với lời chào và danh sách tên
};
